...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-12 13:09`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/c4fbbf54-c7e8-4347-9de1-2d2cc0e195ac.git
$ cd c4fbbf54-c7e8-4347-9de1-2d2cc0e195ac
```
